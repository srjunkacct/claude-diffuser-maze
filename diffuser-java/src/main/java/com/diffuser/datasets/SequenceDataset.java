...
import com.diffuser.datasets.normalization.DatasetNormalizer;
import com.diffuser.datasets.normalization.LimitsNormalizer;
import com.diffuser.datasets.normalization.Normalizer;
    ...
    private Normalizer createNormalizer(String type, float[][] data) {
        switch (type) {
            case "LimitsNormalizer":
                return new com.diffuser.datasets.normalization.LimitsNormalizer(data);
            case "GaussianNormalizer":
                return new com.diffuser.datasets.normalization.GaussianNormalizer(data);
            case "SafeLimitsNormalizer":
                return new com.diffuser.datasets.normalization.SafeLimitsNormalizer(data);
            default:
                return new com.diffuser.datasets.normalization.LimitsNormalizer(data);
        }
    }
